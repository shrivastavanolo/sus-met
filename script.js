...
const questions = {
    ...
    18: [
      {
        ...
        type: "black",
        description:
          "Implementing the 3 R’s helps minimize waste. For example, reusing glass jars for storage, recycling paper and plastic, and reducing unnecessary purchases contribute to environmental sustainability.",
      },
      {
        question:
  ...
  function updateResultImage(score) {
      const scorePercent = ((score/140)*100).toFixed(0);
      ...
      if (scorePercent < 50) {
          ...
          resultMessage.innerHTML = `
              <section>
                  ...
                  <p>🌟 <strong>Here’s how you’ve made a difference:</strong></p>
                  <ul>
